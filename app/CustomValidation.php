...
if($param['REQUEST'][$param['VALIDATIONS']['OLD_PASSWORD_FIELD_NAME']] == $query[0]->password){
...
if((strlen($param['REQUEST'][$param['VALIDATIONS']['NEW_PASSWORD_FIELD_NAME']]) >= 7 ) and (strlen($param['REQUEST'][$param['VALIDATIONS']['NEW_PASSWORD_FIELD_NAME']]) <= 10 )){
	$this -> validation_response['data'][$param['VALIDATIONS']['NEW_PASSWORD_FIELD_NAME']] = $param['REQUEST'][$param['VALIDATIONS']['NEW_PASSWORD_FIELD_NAME']];
}
else{
	$this -> validation_response['error'][$param['VALIDATIONS']['NEW_PASSWORD_FIELD_NAME']] = "Password Must be minimum 7 and maximum 10 characters";
}
