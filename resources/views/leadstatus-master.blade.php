           ...
           <form class="form-horizontal" name="leadstatus_master" id="leadstatus_master"  method="post">
              {{csrf_field()}}
                   ...
                   <div class="form-group row">
                        <label for="Lead_Status" class="col-sm-4 col-form-label">Lead&nbsp;Status:</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="Lead_Status" name="Lead_Status"  value="" placeholder="Lead Status"  required>
                        </div>
                      </div>
